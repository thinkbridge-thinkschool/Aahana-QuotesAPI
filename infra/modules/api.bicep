...
@description('Extra environment variables the composition root wires in — e.g. SQL/Service Bus endpoints from the other modules. Kept generic so this module never needs to know those modules exist.')
